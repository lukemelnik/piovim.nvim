...
assert_true(vim.fn.exists(":PiovimReviewDiff") == 2, ":PiovimReviewDiff command missing")
assert_true(vim.fn.exists(":PiovimReviewClose") == 2, ":PiovimReviewClose command missing")
assert_true(vim.fn.exists(":PiovimReviewRefresh") == 2, ":PiovimReviewRefresh command missing")
assert_true(vim.fn.exists(":PiovimReviewEditNote") == 2, ":PiovimReviewEditNote command missing")
assert_true(vim.fn.exists(":PiovimReviewDeleteNote") == 2, ":PiovimReviewDeleteNote command missing")
assert_true(vim.fn.exists(":PiovimReviewNotes") == 2, ":PiovimReviewNotes command missing")
